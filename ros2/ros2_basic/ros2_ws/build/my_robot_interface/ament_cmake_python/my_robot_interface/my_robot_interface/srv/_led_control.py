...
class Metaclass_LedControl(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interface.srv.LedControl')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interface.srv import _led_control
...
class LedControl(metaclass=Metaclass_LedControl):
    from my_robot_interface.srv._led_control import LedControl_Request as Request
    from my_robot_interface.srv._led_control import LedControl_Response as Response
