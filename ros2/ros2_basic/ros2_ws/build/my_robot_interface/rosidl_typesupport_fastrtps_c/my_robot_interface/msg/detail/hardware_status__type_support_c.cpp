...
#include "my_robot_interface/msg/detail/hardware_status__rosidl_typesupport_fastrtps_c.h"
...
using _HardwareStatus__ros_msg_type = my_robot_interface__msg__HardwareStatus;
...
static uint32_t _HardwareStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interface__msg__HardwareStatus(
...
static size_t _HardwareStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interface__msg__HardwareStatus(
