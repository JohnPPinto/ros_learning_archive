...
#include "my_robot_interface/msg/detail/led_status__rosidl_typesupport_fastrtps_c.h"
...
using _LedStatus__ros_msg_type = my_robot_interface__msg__LedStatus;
...
size_t get_serialized_size_my_robot_interface__msg__LedStatus(
  const void * untyped_ros_message,
...
static uint32_t _LedStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interface__msg__LedStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_robot_interface
size_t max_serialized_size_my_robot_interface__msg__LedStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
static size_t _LedStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interface__msg__LedStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_robot_interface, msg, LedStatus)() {
