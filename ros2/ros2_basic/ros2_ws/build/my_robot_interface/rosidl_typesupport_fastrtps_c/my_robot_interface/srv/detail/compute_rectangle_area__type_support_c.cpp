...
#include "my_robot_interface/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_c.h"
...
using _ComputeRectangleArea_Request__ros_msg_type = my_robot_interface__srv__ComputeRectangleArea_Request;
...
static uint32_t _ComputeRectangleArea_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interface__srv__ComputeRectangleArea_Request(
...
static size_t _ComputeRectangleArea_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interface__srv__ComputeRectangleArea_Request(
...
using _ComputeRectangleArea_Response__ros_msg_type = my_robot_interface__srv__ComputeRectangleArea_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_robot_interface__srv__ComputeRectangleArea_Response(
      untyped_ros_message, 0));
}
...
static size_t _ComputeRectangleArea_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_robot_interface__srv__ComputeRectangleArea_Response(
    full_bounded, is_plain, 0);
