...
#include "my_robot_interface/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_robot_interface::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interface::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &my_robot_interface::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
