...
#include "my_robot_interface/srv/detail/compute_rectangle_area__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const my_robot_interface::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interface::srv::ComputeRectangleArea_Request *>(
    untyped_ros_message);
...
{
  return &my_robot_interface::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Request__handle;
}
...
{
  auto typed_message =
    static_cast<const my_robot_interface::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_robot_interface::srv::ComputeRectangleArea_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_robot_interface::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea_Response__handle;
}
...
{
  return &my_robot_interface::srv::typesupport_fastrtps_cpp::_ComputeRectangleArea__handle;
}
