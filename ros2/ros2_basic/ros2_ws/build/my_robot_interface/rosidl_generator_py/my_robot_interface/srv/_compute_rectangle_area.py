...
class Metaclass_ComputeRectangleArea(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'my_robot_interface.srv.ComputeRectangleArea')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from my_robot_interface.srv import _compute_rectangle_area
...
class ComputeRectangleArea(metaclass=Metaclass_ComputeRectangleArea):
    from my_robot_interface.srv._compute_rectangle_area import ComputeRectangleArea_Request as Request
    from my_robot_interface.srv._compute_rectangle_area import ComputeRectangleArea_Response as Response
