...
{
public:
  explicit Init_Turtle_name(::my_robot_interface::msg::Turtle & msg)
  : msg_(msg)
  {}
  ::my_robot_interface::msg::Turtle name(::my_robot_interface::msg::Turtle::_name_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Turtle_name theta(::my_robot_interface::msg::Turtle::_theta_type arg)
  {
...
{
  return my_robot_interface::msg::builder::Init_Turtle_x();
}
